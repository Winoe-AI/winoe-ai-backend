...
def require_active_window_impl(
    ...
    *,
    ...
    if task_window.window_start_at is None or task_window.window_end_at is None:
        ...
        raise build_schedule_invalid_window_error(candidate_session, task, task_window=task_window)
    logger.info(
    ...
    raise build_task_window_closed_error(candidate_session, task, task_window=task_window)
...
def ensure_schedule_started_for_content_impl(
    ...
    *,
    ...
    raise build_schedule_not_started_error(candidate_session, window_start_at, window_end_at)
