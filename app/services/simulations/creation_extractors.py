...
from app.domains.simulations.schemas import normalize_eval_enabled_by_day
...
def extract_ai_fields(
    ...
    return notice_version, notice_text, normalize_eval_enabled_by_day(
        eval_by_day, strict=False
    )
