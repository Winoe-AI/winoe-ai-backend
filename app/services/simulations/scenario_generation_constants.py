...
OPENAI_API_ENV_KEYS = ("TENON_OPENAI_API_KEY", "OPENAI_API_KEY")
ANTHROPIC_API_ENV_KEYS = ("TENON_ANTHROPIC_API_KEY", "ANTHROPIC_API_KEY")
DEMO_MODE_ENV_KEYS = ("TENON_DEMO_MODE", "TENON_SCENARIO_DEMO_MODE")
