...
def _completed_response(*, run, candidate_session_id: int, duration_ms: int) -> dict[str, Any]:
    return {
        "status": "completed",
...
def _failed_response(*, run, candidate_session_id: int, duration_ms: int) -> dict[str, Any]:
    return {
        "status": "failed",
        "candidateSessionId": candidate_session_id,
        "evaluationRunId": run.id,
