...
from app.services.evaluations.evaluator_helpers import _segment_text, _to_excerpt
from app.services.evaluations.evaluator_models import DayEvaluationInput


def _score_for_day(day: DayEvaluationInput, evidence: Sequence[dict[str, Any]]) -> float:
