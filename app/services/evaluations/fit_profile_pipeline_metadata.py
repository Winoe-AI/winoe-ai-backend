...
def _resolve_cutoff_commit_shas(
    *,
    ...
    cutoff_commit_sha = day3_final_sha if day3_final_sha != "day3-missing" else day2_checkpoint_sha
...
def _build_run_metadata(
    *,
    ...
    day2_checkpoint_sha, day3_final_sha, cutoff_commit_sha = _resolve_cutoff_commit_shas(
        day_audits=day_audits,
        submissions_by_day=submissions_by_day,
    )
    run_metadata = {
    ...
    return run_metadata, basis_refs, day2_checkpoint_sha, day3_final_sha, cutoff_commit_sha
