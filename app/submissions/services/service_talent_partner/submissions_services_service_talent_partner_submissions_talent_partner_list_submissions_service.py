"""Application module for submissions services service Talent Partner submissions Talent Partner list submissions service workflows."""
...
async def list_submissions(
    ...
    stmt = (
        ...
        .where(Trial.created_by == talent_partner_id)
