...
from app.repositories.jobs.repository_create_get import create_or_get_idempotent
...
async def create_or_update_idempotent(
    ...
    *,
    ...
    existing = await load_idempotent_job(
        db, company_id=company_id, job_type=normalized_type, idempotency_key=normalized_key
    )
