...
from app.domains.submissions.schemas import HandoffStatusResponse
...
async def handoff_status_route_impl(
    *,
    ...
    return HandoffStatusResponse(recording=recording_payload, transcript=transcript_payload)
