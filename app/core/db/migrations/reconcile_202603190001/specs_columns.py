...
COLUMN_SPECS: tuple[tuple[str, str, sa.TypeEngine[object]], ...] = (
    ("simulations", "active_scenario_version_id", sa.Integer()),
    ("simulations", "pending_scenario_version_id", sa.Integer()),
