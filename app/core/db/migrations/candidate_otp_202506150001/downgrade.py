...
_COLUMN_SPECS = (
    ...
    ("candidate_access_token_expires_at", lambda sa: sa.DateTime(timezone=True), True, None),
    ("candidate_access_token_issued_at", lambda sa: sa.DateTime(timezone=True), True, None),
    ...
    ("verification_email_last_attempt_at", lambda sa: sa.DateTime(timezone=True), True, None),
)
