"""Application module for trials services trials scenario versions patching service workflows."""
...
from app.trials.services.trials_services_trials_scenario_versions_constants import (
    ...
    ALLOWED_EDITABLE_TRIAL_STATUSES,
)
from app.trials.services.trials_services_trials_scenario_versions_validation_base_service import (
    validate_notes,
    validate_storyline,
)
from app.trials.services.trials_services_trials_scenario_versions_validation_rubric_service import (
    validate_rubric,
)
from app.trials.services.trials_services_trials_scenario_versions_validation_task_prompts_service import (
...
def is_editable_trial_status(status_value: str | None) -> bool:
    """Return whether editable trial status."""
    return status_value in ALLOWED_EDITABLE_TRIAL_STATUSES
