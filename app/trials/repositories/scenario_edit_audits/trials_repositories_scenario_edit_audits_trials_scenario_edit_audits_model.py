"""Application module for trials repositories scenario edit audits trials scenario edit audits model workflows."""
...
class ScenarioEditAudit(Base, TimestampMixin):
    ...
    talent_partner_id: Mapped[int] = mapped_column(
        ForeignKey("users.id"),
        nullable=False,
    )
    ...
    talent_partner = relationship("User")
