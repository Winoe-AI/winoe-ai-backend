"""Application module for trials schemas trials create schema workflows."""
...
class TrialCreate(BaseModel):
    ...
    dayWindowOverrides: dict[str, TrialDayWindowOverride] | None = None
