"""Application module for Talent Partners services Talent Partners admin ops jobs service workflows."""
...
from app.talent_partners.services.talent_partners_services_talent_partners_admin_ops_job_helpers_service import (
...
async def requeue_job(
    ...
    *,
    ...
    if not no_op:
        if force and job.status not in {
            JOB_STATUS_RUNNING,
            JOB_STATUS_DEAD_LETTER,
            JOB_STATUS_SUCCEEDED,
        }:
