...
from app.simulations.services.simulations_services_simulations_scenario_versions_patch_utils_service import (
...
async def patch_scenario_version(
    ...
    *,
    ...
    scenario_version = await _require_scenario_for_patch(
        db, scenario_version_id, simulation
    )
