...
def resolve_simulation_ai_fields(
    *,
    ...
    resolved_notice_text = (
        ...
        or _coerce_notice_value(fallback_notice_text, max_length=MAX_AI_NOTICE_TEXT_CHARS)
        or AI_NOTICE_DEFAULT_TEXT
    )
    resolved_eval = default_ai_eval_enabled_by_day()
    fallback_eval = normalize_eval_enabled_by_day(fallback_eval_enabled_by_day, strict=False)
...
__all__ = ["normalize_eval_enabled_by_day", "resolve_simulation_ai_fields"]
