...
from app.jobs.worker_runtime.registry import (
    clear_handlers,
    has_handler,
    register_builtin_handlers,
    register_handler,
)
from app.jobs.worker_runtime.run_once import run_once as _run_once
...
async def run_forever(
    *,
    ...
    while True:
        handled = await _run_once(session_maker=session_maker, worker_id=resolved_worker_id)
        if not handled:
