...
def build_payload(
    ...
    *,
    ...
    return ArtifactParsePayload(
        ...
        payload_candidate_session_id=parse_positive_int(payload_json.get("candidateSessionId")),
        payload_task_id=parse_positive_int(payload_json.get("taskId")),
        workflow_completed_at=parse_iso_datetime(payload_json.get("workflowCompletedAt")),
    )
