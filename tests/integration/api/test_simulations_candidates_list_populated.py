...
from tests.integration.api.simulations_candidates_helpers import (
...
@pytest.mark.asyncio
async def test_simulation_with_multiple_sessions_returns_all_and_has_report(async_client, async_session):
    ...
    async_session.add(FitProfile(candidate_session_id=cs2.id, generated_at=datetime.now(UTC)))
